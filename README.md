...
- Class **0** (non-depressive): 8000 samples

- Class **1** (depressive): 2314 samples
...
This notebook uses a pre-trained BERT model to evaluate the likelihood that a tweet expresses depressive sentiments. This model applies **deep learning** and **transfer learning** from the **transformer-based BERT architecture**.
...
####  5. Example Inference
One tweet is selected randomly, using its index (e.g. 42.).
